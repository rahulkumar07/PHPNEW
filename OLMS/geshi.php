...
class GeSHi {
     ...
     *  If false is specified, the line will be removed from special highlighting
     ...
     * stylesheet generators as they rely on some style information being preprocessed
     * @access private
     */
    ...
    function get_stylesheet($economy_mode = true) {
        ...
        if (!$economy_mode) {
            $stylesheet = "/**\n".
                ...
                " * GeSHi (C) 2011 - till now from OCCWCC\n" .
                " * (http://BIZfromAIT.co.nr/)\n".
                " * --------------------------------------\n".
                " */\n";
        } else {
            $stylesheet = "/**\n".
