...
function validateUpload()
{
 var fup = document.getElementById('file');
     ...
     if(ext == "cpp" || ext == "CPP" )
      ...
      {
                alert("Upload  only .cpp or .CPP extensions");
		fup.focus();
                return false;
       }
}
...
<form name=myform2 action="upload_cpp.php" onsubmit="return validateUpload()"  method="post"
...
<form name= myForm action="cppcompile.php" onsubmit="return validateForm()" method="post" >
